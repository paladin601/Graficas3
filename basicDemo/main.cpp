...
// Window title
const char* windowTitle = "Tarea CCG 1";
...
bool init()
{
	...
	textureId = loaderTexture.load("assets/images/tigresish1.jpg");
	textureId1 = loaderTexture.load("assets/images/tigresish.jpg");
	textureId2 = loaderTexture.load("assets/images/test.jpg");
...
void processKeyboardInput(GLFWwindow* window)
{
	...
	if (isKeyPress(GLFW_KEY_1))
		select=1;
	if (isKeyPress(GLFW_KEY_2))
		select = 2;
	if (isKeyPress(GLFW_KEY_3))
		select = 3;


	if (isKeyPress(GLFW_KEY_4))
		selectTexture = 1;
	if (isKeyPress(GLFW_KEY_5))
		selectTexture = 2;
	if (isKeyPress(GLFW_KEY_6))
		selectTexture = 3;
...
void render()
{
	...
	glBindTexture(GL_TEXTURE_2D, getTextureActive());
	shader->setInt("textureImage", 0);
	shader->setInt("select", select);
